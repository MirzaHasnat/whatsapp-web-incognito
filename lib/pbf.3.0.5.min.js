...
// WAIncognito: Force window.Pbf to be pinned regardless of which UMD branch ran.
// When WhatsApp's page defines window.module, the UMD takes the Node.js path and
// does: module.exports = PbfConstructor  (instead of window.Pbf = PbfConstructor).
// This IIFE reads back module.exports and writes it to window.Pbf to correct that.
(function(){
  try {
    if (typeof window !== 'undefined' && typeof window.Pbf !== 'function') {
      var _c = (typeof module !== 'undefined' && module && typeof module.exports === 'function') ? module.exports : null;
      if (!_c && typeof exports !== 'undefined' && typeof exports === 'function') _c = exports;
      if (_c) { window.Pbf = _c; }
    }
  } catch(e) { /* never crash on pinning */ }
})();